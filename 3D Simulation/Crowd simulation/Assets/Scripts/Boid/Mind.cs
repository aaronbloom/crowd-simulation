...
namespace Assets.Scripts.Boid {
    public class Mind {
        ...
        public Mind(Boid boid) {
            this.boid = boid;
            drinkNeed = new Need(MindState.Thirsty, Random.Range(2, boid.Properties.DrinkNeedRate), 2000);
            toiletNeed = new Need(MindState.Incontenent, Random.Range(0, boid.Properties.ToiletNeedRate), 2000);
            danceNeed = new Need(MindState.Dancey, Random.Range(1, boid.Properties.DanceNeedRate), 2000);
